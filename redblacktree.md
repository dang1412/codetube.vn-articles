...
Các bạn có thể thử tất cả các trường hợp được giải thích sau đây bằng cách thêm hoặc xóa các phần tử trên cây đỏ đen sau và kiểm chứng từng bước hoạt động của thuật toán.
